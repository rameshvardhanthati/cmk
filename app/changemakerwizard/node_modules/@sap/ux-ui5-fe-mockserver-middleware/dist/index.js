...
function FEMiddleware(_a) {
    ...
    if (serverConfig.mockFolder) {
        ...
        if (serverConfig.service.metadataCdsPath) {
            serverConfig.service.metadataCdsPath = fileLoader_1.resolvePath(basePath, serverConfig.service.metadataCdsPath);
        }
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (fs.existsSync(path_1.default.join(config.mockFolder, 'config.js'))) {
                        mockConfig = require(/* webpackIgnore: true */ path_1.default.join(config.mockFolder, 'config.js'));
                    }
                    else {
                ...
                case 2:
                    ...
                    serverInit_1 = odata_1.oDataHandler(config).then(function (oDataHandlerInstance) {
                        if (config.contextBasedIsolation) {
                            var subRouter = router_1.default();
...
function batchRequestHandler(metadata, dataAccess, config) {
    ...
    return function (req, res) {
        ...
        function handlePart(part) {
            return __awaiter(this, void 0, void 0, function () {
                var baseUrl, _a, method, url, odataReq, _b, patchData, updatedData, postData, actionResponse, createdData, actionResponse, data, e_1;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createBoundary = exports.createGenKeyValue = exports.createGenKeyProperty = void 0;
/**
 * @param genKeyName
 */
function createGenKeyProperty(genKeyName) {
    return {
...
exports.createGenKeyProperty = createGenKeyProperty;
/**
 * @param index
 */
function createGenKeyValue(index) {
    return '' + Date.now() + (index + 1);
}
exports.createGenKeyValue = createGenKeyValue;
/**
 * @param context
 */
...
function catalogService(config, version) {
    ...
    if (config.annotations) {
        router.get('/Annotations*', function (req, res) {
            fileLoader_1.loadFile(config.annotations.localPath)
                .then(function (data) {
...
var ExecutionError = /** @class */ (function (_super) {
     ...
     * @param isSAPMessage
     */
    function ExecutionError(message, statusCode, messageData, isSAPMessage) {
...
var MockDataEntitySet = /** @class */ (function () {
    ...
    MockDataEntitySet.read = function (mockDataRootFolder, entity, generateMockData, isDraft) {
        return __awaiter(this, void 0, void 0, function () {
            var path, jsPath, outData, isInitial, e_1, _a, fileContent, outJsonData_1, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    log = logger_1.getLogger('server:ux-fe-mockserver');
                    if (!config.service.metadataCdsPath) return [3 /*break*/, 4];
                ...
                case 2:
                    stringToCds = _a.sent();
                    return [4 /*yield*/, stringToCds.compileCDS(cdsContent, config.service.cdsServiceName)];
                case 3:
                    edmx = _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, fileLoader_1.loadFile(config.service.metadataXmlPath)];
                case 5:
                    edmx = _a.sent();
                    _a.label = 6;
                ...
                case 7:
                    ...
                    if (!(config.watch && !fileLoader_1.isInBrowser())) return [3 /*break*/, 9];
                    watchPath = [config.service.mockdataRootPath];
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!config.service.metadataCdsPath) return [3 /*break*/, 3];
                                        return [4 /*yield*/, fileLoader_1.loadFile(config.service.metadataCdsPath)];
                                    case 1:
                                        cdsContent = _a.sent();
                                        return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(4087)); })];
                                    case 2:
                                        ...
                                        return [3 /*break*/, 5];
                                    case 3: return [4 /*yield*/, fileLoader_1.loadFile(config.service.metadataXmlPath)];
                                    case 4:
                                        edmx = _a.sent();
                                        _a.label = 5;
                ...
                case 9:
                    ...
                    router.get('/*', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                        var odataReq, actionResponse, response, data, e_1, errorResponse;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    odataReq = metadata.getVersion() === '2.0'
                                ...
                                case 2:
                                    ...
                                    response = void 0;
                                    if (!(actionResponse === null)) return [3 /*break*/, 4];
                                    return [4 /*yield*/, dataAccess.getData(odataReq)];
                                case 3:
                                    data = _a.sent();
                    ...
                    router.post('/*', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                        var odataReq, request, errorResponse;
                        var _this = this;
                        return __generator(this, function (_a) {
                            odataReq = metadata.getVersion() === '2.0'
                                ? new odataV2Request_1.ODataV2Request(req.baseUrl, req.url.substring(1), metadata)
                            ...
                            try {
                                ...
                                errorResponse = odataReq.createErrorResponse(e);
                                errorResponse.writeToResponse(res);
                            }
                            return [2 /*return*/];
                        });
                        ...
                        return __generator(this, function (_a) {
                            ...
                            try {
                                ...
                                request.getBodyAsString(function (body) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, dataAccess.updateData(odataReq, JSON.parse(body))];
                                            case 1:
                                                data = _a.sent();
                                                response = odataReq.createResponse(data);
                                                response.writeToResponse(res);
    ...
    function FilterParser() {
        ...
        $.expression = $.RULE('expression', function () {
            ...
            $.OPTION2(function () {
                ...
                $.OPTION3(function () { return $.CONSUME(CLOSE); });
                $.OPTION4(function () {
                    $.CONSUME5(WS);
                    andOr = $.CONSUME(ANDOR);
                    currentOperator = andOr.image.toUpperCase();
                    $.CONSUME6(WS);
                    isOpen = $.OPTION5(function () { return $.CONSUME2(OPEN); });
                    ...
                    if (currentOperator === subExpr.operator || subExpr.operator === '') {
                        ...
                        if ((currentOperator === 'AND' && isOpen === undefined) ||
                    ...
                    //currentOperator = subExpr.operator;
                    $.OPTION6(function () { return $.CONSUME2(CLOSE); });
                });
                $.OPTION7(function () { return $.CONSUME3(CLOSE); });
            });
...
var readFileP;
var existsP;
if (!fs_1.readFileSync) {
    isBrowser = true;
}
else {
    readFileP = util_1.promisify(fs_1.readFile);
    existsP = util_1.promisify(fs_1.exists);
}
/**
 *
 */
