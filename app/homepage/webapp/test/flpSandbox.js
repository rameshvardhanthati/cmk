		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ChangeMaker Home Page ",
									"targetURL": "#comchangemakerhomehomepage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchangemakerhomehomepage-display": {
								"semanticObject": "comchangemakerhomehomepage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.changemaker.home.homepage",
									"url": sap.ui.require.toUrl("com/changemaker/home/homepage")
								}
							}
						}
					}
