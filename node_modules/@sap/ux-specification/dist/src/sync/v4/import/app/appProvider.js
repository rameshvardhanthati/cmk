...
function determinePageType(target, logger, routingTargetId) {
    ...
    if (target['name']) {
        ...
        else if (target['name'].endsWith(common_2.PageTypeV4.AnalyticalListPage)) {
            pageType = common_2.PageTypeV4.AnalyticalListPage;
        }
        else {
            pageType = undefined;
        }
...
function convertSettingsToConfig(target, pageType, manifest, schemas, logger, page, id) {
...
function getPagesAndConfigs(manifest, schemas, logger) {
    ...
    for (const id in routing.targets) {
        ...
        convertSettingsToConfig(target, pageType, manifest, schemas, logger, page, id);
    }
    return pages;
}
