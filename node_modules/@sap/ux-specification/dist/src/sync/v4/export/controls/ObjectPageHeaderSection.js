...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName, manifest, sectionId) => application_1.getHeadeFacetSettingPath(pageName, manifest, sectionId) + '/flexSettings'
        }
    }),
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: application_1.getHeadeFacetSettingPath
        }
    }),
    decorators_1.validity({
        since: '1.81.0'
