...
function addSettings(importParameters, analyticalListPageConfig, factory, pageKey) {
    ...
    index_1.transferSettingsOfObject(analyticalListPageConfig.filterBar, importParameters.manifest, importParameters.jsonSchema['definitions']['AnalyticalListPageFilterBar'], pageKey, importParameters.logger);
    //Chart settings:
...
function createAnalyticalListPageConfig(importParameters) {
    ...
    const pageKeys = [];
    const v2Page = utils_1.findAnalyticalListPage(importParameters.manifest[common_1.ManifestSection.generic].pages, pageKeys);
    if (!v2Page) {
        extensionLogger_1.log(importParameters.logger, {
            severity: "error" /* Error */,
    ...
    listReport_1.addFragments(config, importParameters.manifest, v2Page, common_1.PageType.AnalyticalListPage, importParameters.fragments);
    return config;
}
