...
const margin = { top: 0, right: 0, bottom: 0, left: 0 }, innerWidth = width - margin.left - margin.right, innerHeight = height - margin.top - margin.bottom;
// helper variables
...
const tooltipElements = function (d) {
    const closeButton = '<div id="b2">' + closeIcon + '</div>', learnButton = '<div id="b1">Learn more</div>', name = '<div class="tip_prop">' + d.data.name + ' </div>', description = '<div class="tip_desc">' + d.data.description + '</div>', type = '<div class="tip_type">' + d.data.type + '</div>', controlType = '<div class="tip_control">' + d.data.control + '</div>';
...
function update(source) {
    ...
    childCount(0, root);
    const newHeight = d3.max(levelWidth) * 35; // pixels per line
