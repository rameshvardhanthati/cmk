...
function generateCustomPage(basePath, data, fs) {
    ...
    fs.copyTpl((0, path_1.join)(root, 'ext/View.xml'), (0, path_1.join)(config.path, `${config.name}.view.xml`), config);
    fs.copyTpl((0, path_1.join)(root, 'ext/Controller.js'), (0, path_1.join)(config.path, `${config.name}.controller.js`), config);
    return fs;
}
